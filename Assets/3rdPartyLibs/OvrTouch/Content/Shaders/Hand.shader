...
Shader "OvrTouch/Hand" {
	...
	SubShader {
		...
		void surf (Input input, inout SurfaceOutputStandard output) {
			...
			half3 emission = lerp(ColorBlack, _ColorPrimary.rgb, rim);
			emission = lerp(emission, _ColorSecondary.rgb, 2 * wireframeTex.b * wireTex.g);
			emission += rim * 0.5 * vertexColor.r;

			// Compute alpha term
			half aAlpha = 8 * wireframeTex.r * wireTex.g * vertexColor.r * _ColorPrimary.a;
			half bAlpha = rim * vertexColor.r * _ColorSecondary.a;
